...
void Dialog::setOpenFileName()
{
    ...
    QString fileName = QFileDialog::getOpenFileName(this, tr("QFileDialog::getOpenFileName()"), openFileNameLabel, tr("All Files (*);;Text Files (*.txt)"), &selectedFilter, options);
    if (!fileName.isEmpty())
...
void Dialog::infomationMessage()
{
    QMessageBox::StandardButton reply;
    reply = QMessageBox::information(
            this, tr("QMessageBox::infomation()"), MESSAGE);
    if (reply == QMessageBox::Ok)
        infomationLabel->setText(tr("Ok"));
    else
        infomationLabel->setText(tr("Escape"));
}
